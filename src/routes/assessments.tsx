...
import { Laptop, Network, ArrowRight } from "lucide-react";
...
export const Route = createFileRoute("/assessments")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Choose a business health assessment from Simple Secure Solutions.",
      },
    ],
  }),
          ...
          <div className="mx-auto max-w-5xl px-5 sm:px-6 lg:px-10">
            <div className="grid gap-5 md:grid-cols-2">
              <Reveal>
                ...
                >
                  <span className="grid h-12 w-12 place-items-center rounded-xl bg-copper-soft text-copper">
                    <Laptop className="h-6 w-6" />
                  </span>
                  <h2 className="mt-5 font-display text-2xl text-navy sm:text-3xl">
                    Technology Equipment Health Check
                  </h2>
                  <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                    A practical assessment of the computers and equipment your business relies on every day.
                  </p>
              ...
              <Reveal delay={80}>
                ...
                >
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                    A practical assessment of your connectivity, network reliability, power protection and CCTV readiness.
                  </p>
                  <span className="mt-6 inline-flex items-center gap-2 text-sm font-medium text-navy">
                    Start assessment
                    <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
